...
public class JuegoMecanografiaMedio {

    // cantidad de letras que se mostrarán en la partida
    private final int CANTIDAD_RONDAS = 10;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new JuegoMecanografiaMedio());
    }
